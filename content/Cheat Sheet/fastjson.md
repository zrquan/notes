...
## 各版本 payload 复现 {#各版本payload复现}

<https://github.com/safe6Sec/ShiroAndFastJson>


## 判断是否用了 fastjson {#判断是否用了fastjson}


### 鉴别 fastjson {#鉴别fastjson}
...
原理同 ssrf 漏洞。请求本机已开放端口不延时，请求不开放的端口则延时。<br />
...
<https://xz.aliyun.com/t/7482><br />
<https://xz.aliyun.com/t/7789#toc-4><br />
主要用 codeql 进行挖掘
...
## FastJson 与原生反序列化 {#fastjson与原生反序列化}

<https://y4tacker.github.io/2023/03/20/year/2023/3/FastJson%E4%B8%8E%E5%8E%9F%E7%94%9F%E5%8F%8D%E5%BA%8F%E5%88%97%E5%8C%96/><br />
...
### Fastjson 1.2.22-1.2.24 {#fastjson-1.2.22-1.2.24}
...
#### c3p0#JndiRefForwardingDataSource {#c3p0jndirefforwardingdatasource}
...
#### shiro#JndiObjectFactory {#shirojndiobjectfactory}
...
#### shiro#JndiRealmFactory {#shirojndirealmfactory}
...
#### 1.2.33 &lt;= fastjson &lt;= 1.2.47 {#fastjson-1.2.47}
...
#### c3p0#WrapperConnectionPoolDataSource {#c3p0wrapperconnectionpooldatasource}
...
### Fastjson 1.2.25-1.2.41 {#fastjson-1.2.25-1.2.41}
...
### Fastjson 1.2.25-1.2.42 {#fastjson-1.2.25-1.2.42}
...
### Fastjson 1.2.25-1.2.43 {#fastjson-1.2.25-1.2.43}
...
### Fastjson 1.2.25-1.2.45 {#fastjson-1.2.25-1.2.45}
...
### Fastjson1.2.25-1.2.47 通杀 {#fastjson1.2.25-1.2.47通杀}
...
### Fastjson 1.2.36 - 1.2.62 {#fastjson-1.2.36---1.2.62}
...
### Fastjson1.2.5 &lt;= 1.2.59 {#fastjson1.2.5-1.2.59}
...
### Fastjson1.2.5 &lt;= 1.2.60 {#fastjson1.2.5-1.2.60}
...
### Fastjson1.2.5 &lt;= 1.2.61 {#fastjson1.2.5-1.2.61}
...
### Fastjson &lt;1.2.62 {#fastjson-1.2.62}
...
### fastjson&lt;=1.2.66 {#fastjson1.2.66}
...
### fastjson&lt;=1.2.67 {#fastjson1.2.67}
...
### fastjson&lt;=1.2.68 {#fastjson1.2.68}
...
### fastjson&lt;=1.2.68 {#fastjson1.2.68-1}


### fastjson 未知版本 {#fastjson未知版本}
